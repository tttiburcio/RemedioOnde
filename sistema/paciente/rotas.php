    ...
    <head>
        ...
        <script>
            ...
            function buscarMedicamento() {
                const code = document.getElementById("selectjs").value;
                initMap(code);
            }
        </script>
                            ...
                            <ul class="list-unstyled navbar__list">
                                <li class="active has-sub">
                                    <a class="js-arrow" href="#">
                                        <i class="far fa-check-square"></i>Rotas Medicamentos</a>
                                </li>
                                <li>
        ...
        <div class="page-container">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">Pesquisa de Medicamentos</div>
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h5 class="text-center title-2">Rotas UBS's - Medicamentos</h5>
                                        </div>
                                        <hr>
                                        <form action="" method="post" novalidate="novalidate">
                                            <div class="form-group">
                                                ...
                                                <br>
                                                <select name="" class="form-control" id="selectjs" onchange="return buscarMedicamento();">
                                                    <option value='-1'>Escolha um remédio</option>
                                                    <?php
                                                    include_once '../../conexao.php';
                                                    $conn = getConnection();
                                                    $result = mysqli_query($conn, "Select * From tbMedicamento ORDER BY nomeMedicamento");
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card-header"><i class="zmdi zmdi-map"></i> Maps</div>
                            <div class="card-body">
                                <div class="card-title">
                                    <h5 class="text-center title-2">Medicamento diponível nas UBS's marcadas!</h5>
                                    <hr>
                                </div>
                            </div>
                        </div>
                ...
                <script>
                    ...
                    function initMap(remedioCode = -1) {
                        getLocation().then((resp) => {
                            ...
                            downloadUrl(`../result.php?code=${remedioCode}`, (data) => {
